...
namespace NativeScript
{
	...
	public static class Bindings
	{
		...
		/*BEGIN CPP DELEGATES*/
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate int NewBaseNativeScriptDelegateType(int param0);
		public static NewBaseNativeScriptDelegateType NewBaseNativeScript;
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void DestroyBaseNativeScriptDelegateType(int param0);
		public static DestroyBaseNativeScriptDelegateType DestroyBaseNativeScript;
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void NativeAbstractBaseNativeScriptUpdateDelegateType(int thisHandle);
		public static NativeAbstractBaseNativeScriptUpdateDelegateType NativeAbstractBaseNativeScriptUpdate;
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void NativeAbstractBaseNativeScriptStartDelegateType(int thisHandle);
		public static NativeAbstractBaseNativeScriptStartDelegateType NativeAbstractBaseNativeScriptStart;
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void NativeAbstractBaseNativeScriptAwakeDelegateType(int thisHandle);
		public static NativeAbstractBaseNativeScriptAwakeDelegateType NativeAbstractBaseNativeScriptAwake;
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void NativeAbstractBaseNativeScriptPassGameConfigDelegateType(int thisHandle, System.IntPtr param0);
		public static NativeAbstractBaseNativeScriptPassGameConfigDelegateType NativeAbstractBaseNativeScriptPassGameConfig;
		
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		public delegate void NativeAbstractBaseNativeScriptStartSimulationDelegateType(int thisHandle);
		public static NativeAbstractBaseNativeScriptStartSimulationDelegateType NativeAbstractBaseNativeScriptStartSimulation;
		...
		/*BEGIN IMPORTS*/
		[DllImport(PLUGIN_NAME, CallingConvention = CallingConvention.Cdecl)]
		public static extern int NewBaseNativeScript(int thisHandle);
		
		[DllImport(PLUGIN_NAME, CallingConvention = CallingConvention.Cdecl)]
		public static extern void DestroyBaseNativeScript(int thisHandle);
		
		[DllImport(PLUGIN_NAME, CallingConvention = CallingConvention.Cdecl)]
		public static extern void NativeAbstractBaseNativeScriptUpdate(int thisHandle);
		
		[DllImport(PLUGIN_NAME, CallingConvention = CallingConvention.Cdecl)]
		public static extern void NativeAbstractBaseNativeScriptStart(int thisHandle);
		
		[DllImport(PLUGIN_NAME, CallingConvention = CallingConvention.Cdecl)]
		public static extern void NativeAbstractBaseNativeScriptAwake(int thisHandle);
		
		[DllImport(PLUGIN_NAME, CallingConvention = CallingConvention.Cdecl)]
		public static extern void NativeAbstractBaseNativeScriptPassGameConfig(int thisHandle, int param0);
		
		[DllImport(PLUGIN_NAME, CallingConvention = CallingConvention.Cdecl)]
		public static extern void NativeAbstractBaseNativeScriptStartSimulation(int thisHandle);
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate int UnityEngineObjectMethodInstantiateUnityEngineObjectDelegateType(int originalHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate int UnityEngineGameObjectMethodAddComponentNativeBaseNativeScriptDelegateType(int thisHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate int UnityEngineGameObjectMethodAddComponentNativeBaseNativeEntityViewDelegateType(int thisHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate int UnityEngineGameObjectMethodGetComponentNativeBaseNativeEntityViewDelegateType(int thisHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		...
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate void UnityEngineProfilingProfilerMethodBeginSampleSystemStringDelegateType(int nameHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate void UnityEngineProfilingProfilerMethodEndSampleDelegateType();
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate float UnityEngineTimePropertyGetDeltaTimeDelegateType();
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate int NativeEventHubConstructorDelegateType();
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate void NativeEventHubMethodInvokeEntityDestroyedSystemUInt32DelegateType(int thisHandle, uint e);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate int NativeAbstractBaseNativeScriptPropertyGetEventsDelegateType(int thisHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate void BaseNativeScriptConstructorDelegateType(int cppHandle, ref int handle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate void ReleaseBaseNativeScriptDelegateType(int handle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate uint NativeBaseNativeEntityViewPropertyGetEntityRefDelegateType(int thisHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate void NativeBaseNativeEntityViewPropertySetEntityRefDelegateType(int thisHandle, uint value);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate int UnityEngineResourcesMethodLoadUnityEngineGameObjectSystemStringDelegateType(int pathHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		delegate int NativeUnityTypeHelpersMethodDowncastUnityEngineGameObjectUnityEngineObjectDelegateType(int objHandle);
		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		...
		static readonly UnityEngineObjectMethodInstantiateUnityEngineObjectDelegateType UnityEngineObjectMethodInstantiateUnityEngineObjectDelegate = new UnityEngineObjectMethodInstantiateUnityEngineObjectDelegateType(UnityEngineObjectMethodInstantiateUnityEngineObject);
		...
		static readonly UnityEngineGameObjectMethodAddComponentNativeBaseNativeScriptDelegateType UnityEngineGameObjectMethodAddComponentNativeBaseNativeScriptDelegate = new UnityEngineGameObjectMethodAddComponentNativeBaseNativeScriptDelegateType(UnityEngineGameObjectMethodAddComponentNativeBaseNativeScript);
		static readonly UnityEngineGameObjectMethodAddComponentNativeBaseNativeEntityViewDelegateType UnityEngineGameObjectMethodAddComponentNativeBaseNativeEntityViewDelegate = new UnityEngineGameObjectMethodAddComponentNativeBaseNativeEntityViewDelegateType(UnityEngineGameObjectMethodAddComponentNativeBaseNativeEntityView);
		static readonly UnityEngineGameObjectMethodGetComponentNativeBaseNativeEntityViewDelegateType UnityEngineGameObjectMethodGetComponentNativeBaseNativeEntityViewDelegate = new UnityEngineGameObjectMethodGetComponentNativeBaseNativeEntityViewDelegateType(UnityEngineGameObjectMethodGetComponentNativeBaseNativeEntityView);
		...
		static readonly UnityEngineProfilingProfilerMethodBeginSampleSystemStringDelegateType UnityEngineProfilingProfilerMethodBeginSampleSystemStringDelegate = new UnityEngineProfilingProfilerMethodBeginSampleSystemStringDelegateType(UnityEngineProfilingProfilerMethodBeginSampleSystemString);
		static readonly UnityEngineProfilingProfilerMethodEndSampleDelegateType UnityEngineProfilingProfilerMethodEndSampleDelegate = new UnityEngineProfilingProfilerMethodEndSampleDelegateType(UnityEngineProfilingProfilerMethodEndSample);
		...
		static readonly NativeEventHubConstructorDelegateType NativeEventHubConstructorDelegate = new NativeEventHubConstructorDelegateType(NativeEventHubConstructor);
		static readonly NativeEventHubMethodInvokeEntityDestroyedSystemUInt32DelegateType NativeEventHubMethodInvokeEntityDestroyedSystemUInt32Delegate = new NativeEventHubMethodInvokeEntityDestroyedSystemUInt32DelegateType(NativeEventHubMethodInvokeEntityDestroyedSystemUInt32);
		static readonly NativeAbstractBaseNativeScriptPropertyGetEventsDelegateType NativeAbstractBaseNativeScriptPropertyGetEventsDelegate = new NativeAbstractBaseNativeScriptPropertyGetEventsDelegateType(NativeAbstractBaseNativeScriptPropertyGetEvents);
		static readonly ReleaseBaseNativeScriptDelegateType ReleaseBaseNativeScriptDelegate = new ReleaseBaseNativeScriptDelegateType(ReleaseBaseNativeScript);
		static readonly BaseNativeScriptConstructorDelegateType BaseNativeScriptConstructorDelegate = new BaseNativeScriptConstructorDelegateType(BaseNativeScriptConstructor);
		static readonly NativeBaseNativeEntityViewPropertyGetEntityRefDelegateType NativeBaseNativeEntityViewPropertyGetEntityRefDelegate = new NativeBaseNativeEntityViewPropertyGetEntityRefDelegateType(NativeBaseNativeEntityViewPropertyGetEntityRef);
		static readonly NativeBaseNativeEntityViewPropertySetEntityRefDelegateType NativeBaseNativeEntityViewPropertySetEntityRefDelegate = new NativeBaseNativeEntityViewPropertySetEntityRefDelegateType(NativeBaseNativeEntityViewPropertySetEntityRef);
		static readonly UnityEngineResourcesMethodLoadUnityEngineGameObjectSystemStringDelegateType UnityEngineResourcesMethodLoadUnityEngineGameObjectSystemStringDelegate = new UnityEngineResourcesMethodLoadUnityEngineGameObjectSystemStringDelegateType(UnityEngineResourcesMethodLoadUnityEngineGameObjectSystemString);
		static readonly NativeUnityTypeHelpersMethodDowncastUnityEngineGameObjectUnityEngineObjectDelegateType NativeUnityTypeHelpersMethodDowncastUnityEngineGameObjectUnityEngineObjectDelegate = new NativeUnityTypeHelpersMethodDowncastUnityEngineGameObjectUnityEngineObjectDelegateType(NativeUnityTypeHelpersMethodDowncastUnityEngineGameObjectUnityEngineObject);
		...
		private static void OpenPlugin(InitMode initMode)
		{
			...
			NewBaseNativeScript = GetDelegate<NewBaseNativeScriptDelegateType>(libraryHandle, "NewBaseNativeScript");
			DestroyBaseNativeScript = GetDelegate<DestroyBaseNativeScriptDelegateType>(libraryHandle, "DestroyBaseNativeScript");
			NativeAbstractBaseNativeScriptUpdate = GetDelegate<NativeAbstractBaseNativeScriptUpdateDelegateType>(libraryHandle, "NativeAbstractBaseNativeScriptUpdate");
			NativeAbstractBaseNativeScriptStart = GetDelegate<NativeAbstractBaseNativeScriptStartDelegateType>(libraryHandle, "NativeAbstractBaseNativeScriptStart");
			NativeAbstractBaseNativeScriptAwake = GetDelegate<NativeAbstractBaseNativeScriptAwakeDelegateType>(libraryHandle, "NativeAbstractBaseNativeScriptAwake");
			NativeAbstractBaseNativeScriptPassGameConfig = GetDelegate<NativeAbstractBaseNativeScriptPassGameConfigDelegateType>(libraryHandle, "NativeAbstractBaseNativeScriptPassGameConfig");
			NativeAbstractBaseNativeScriptStartSimulation = GetDelegate<NativeAbstractBaseNativeScriptStartSimulationDelegateType>(libraryHandle, "NativeAbstractBaseNativeScriptStartSimulation");
			...
			ECSBindings.Load(libraryHandle);
			...
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(UnityEngineObjectMethodInstantiateUnityEngineObjectDelegate));
			curMemory += IntPtr.Size;
			...
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(UnityEngineGameObjectMethodAddComponentNativeBaseNativeScriptDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(UnityEngineGameObjectMethodAddComponentNativeBaseNativeEntityViewDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(UnityEngineGameObjectMethodGetComponentNativeBaseNativeEntityViewDelegate));
			curMemory += IntPtr.Size;
			...
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(UnityEngineProfilingProfilerMethodBeginSampleSystemStringDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(UnityEngineProfilingProfilerMethodEndSampleDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(UnityEngineTimePropertyGetDeltaTimeDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(NativeEventHubConstructorDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(NativeEventHubMethodInvokeEntityDestroyedSystemUInt32Delegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(NativeAbstractBaseNativeScriptPropertyGetEventsDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(ReleaseBaseNativeScriptDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(BaseNativeScriptConstructorDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(NativeBaseNativeEntityViewPropertyGetEntityRefDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(NativeBaseNativeEntityViewPropertySetEntityRefDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(UnityEngineResourcesMethodLoadUnityEngineGameObjectSystemStringDelegate));
			curMemory += IntPtr.Size;
			Marshal.WriteIntPtr(memory, curMemory, Marshal.GetFunctionPointerForDelegate(NativeUnityTypeHelpersMethodDowncastUnityEngineGameObjectUnityEngineObjectDelegate));
			curMemory += IntPtr.Size;
			...
			lock (destroyQueueLockObj)
			{
				...
				for (int i = 0; i < count; ++i)
				{
					...
					switch (entry.Function)
					{
						...
						case DestroyFunction.BaseNativeScript:
							DestroyBaseNativeScript(entry.CppHandle);
							break;
		...
		[MonoPInvokeCallback(typeof(UnityEngineObjectMethodInstantiateUnityEngineObjectDelegateType))]
		static int UnityEngineObjectMethodInstantiateUnityEngineObject(int originalHandle)
		{
			try
			{
				var original = (UnityEngine.Object)NativeScript.Bindings.ObjectStore.Get(originalHandle);
		...
		[MonoPInvokeCallback(typeof(UnityEngineGameObjectMethodAddComponentNativeBaseNativeScriptDelegateType))]
		static int UnityEngineGameObjectMethodAddComponentNativeBaseNativeScript(int thisHandle)
		{
			try
			{
				var thiz = (UnityEngine.GameObject)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				var returnValue = thiz.AddComponent<Native.BaseNativeScript>();
				return NativeScript.Bindings.ObjectStore.GetHandle(returnValue);
			}
			catch (System.NullReferenceException ex)
			{
		...
		[MonoPInvokeCallback(typeof(UnityEngineGameObjectMethodAddComponentNativeBaseNativeEntityViewDelegateType))]
		static int UnityEngineGameObjectMethodAddComponentNativeBaseNativeEntityView(int thisHandle)
		{
			try
			{
				var thiz = (UnityEngine.GameObject)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				var returnValue = thiz.AddComponent<Native.BaseNativeEntityView>();
				return NativeScript.Bindings.ObjectStore.GetHandle(returnValue);
			}
			catch (System.NullReferenceException ex)
			{
		...
		[MonoPInvokeCallback(typeof(UnityEngineGameObjectMethodGetComponentNativeBaseNativeEntityViewDelegateType))]
		static int UnityEngineGameObjectMethodGetComponentNativeBaseNativeEntityView(int thisHandle)
		{
			try
			{
				var thiz = (UnityEngine.GameObject)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				var returnValue = thiz.GetComponent<Native.BaseNativeEntityView>();
				return NativeScript.Bindings.ObjectStore.GetHandle(returnValue);
			}
			catch (System.NullReferenceException ex)
			{
		...
		[MonoPInvokeCallback(typeof(UnityEngineProfilingProfilerMethodBeginSampleSystemStringDelegateType))]
		static void UnityEngineProfilingProfilerMethodBeginSampleSystemString(int nameHandle)
		{
			try
			{
		...
		[MonoPInvokeCallback(typeof(UnityEngineProfilingProfilerMethodEndSampleDelegateType))]
		static void UnityEngineProfilingProfilerMethodEndSample()
		{
			try
			{
		...
		[MonoPInvokeCallback(typeof(NativeEventHubConstructorDelegateType))]
		static int NativeEventHubConstructor()
		{
			try
			{
				var returnValue = NativeScript.Bindings.ObjectStore.Store(new Native.EventHub());
				return returnValue;
			}
			catch (System.NullReferenceException ex)
			{
		...
		[MonoPInvokeCallback(typeof(NativeEventHubMethodInvokeEntityDestroyedSystemUInt32DelegateType))]
		static void NativeEventHubMethodInvokeEntityDestroyedSystemUInt32(int thisHandle, uint e)
		{
			try
			{
				var thiz = (Native.EventHub)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				thiz.InvokeEntityDestroyed(e);
			}
			catch (System.NullReferenceException ex)
			{
				UnityEngine.Debug.LogException(ex);
		...
		[MonoPInvokeCallback(typeof(NativeAbstractBaseNativeScriptPropertyGetEventsDelegateType))]
		static int NativeAbstractBaseNativeScriptPropertyGetEvents(int thisHandle)
		{
			try
			{
				var thiz = (Native.AbstractBaseNativeScript)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				var returnValue = thiz.Events;
				return NativeScript.Bindings.ObjectStore.GetHandle(returnValue);
			}
			catch (System.NullReferenceException ex)
			{
		...
		[MonoPInvokeCallback(typeof(BaseNativeScriptConstructorDelegateType))]
		static void BaseNativeScriptConstructor(int cppHandle, ref int handle)
		{
			try
			{
				var thiz = new Native.BaseNativeScript(cppHandle);
		...
		[MonoPInvokeCallback(typeof(ReleaseBaseNativeScriptDelegateType))]
		static void ReleaseBaseNativeScript(int handle)
		{
			try
			{
				Native.BaseNativeScript thiz;
				thiz = (Native.BaseNativeScript)ObjectStore.Get(handle);
				int cppHandle = thiz.CppHandle;
				thiz.CppHandle = 0;
				QueueDestroy(DestroyFunction.BaseNativeScript, cppHandle);
				ObjectStore.Remove(handle);
			}
			catch (System.NullReferenceException ex)
			{
		...
		[MonoPInvokeCallback(typeof(NativeBaseNativeEntityViewPropertyGetEntityRefDelegateType))]
		static uint NativeBaseNativeEntityViewPropertyGetEntityRef(int thisHandle)
		{
			try
			{
				var thiz = (Native.BaseNativeEntityView)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				var returnValue = thiz.EntityRef;
				return returnValue;
			}
			catch (System.NullReferenceException ex)
			{
		...
		[MonoPInvokeCallback(typeof(NativeBaseNativeEntityViewPropertySetEntityRefDelegateType))]
		static void NativeBaseNativeEntityViewPropertySetEntityRef(int thisHandle, uint value)
		{
			try
			{
				var thiz = (Native.BaseNativeEntityView)NativeScript.Bindings.ObjectStore.Get(thisHandle);
				thiz.EntityRef = value;
			}
			catch (System.NullReferenceException ex)
			{
				UnityEngine.Debug.LogException(ex);
		...
		[MonoPInvokeCallback(typeof(UnityEngineResourcesMethodLoadUnityEngineGameObjectSystemStringDelegateType))]
		static int UnityEngineResourcesMethodLoadUnityEngineGameObjectSystemString(int pathHandle)
		{
			try
			{
				var path = (string)NativeScript.Bindings.ObjectStore.Get(pathHandle);
				var returnValue = UnityEngine.Resources.Load<UnityEngine.GameObject>(path);
				return NativeScript.Bindings.ObjectStore.GetHandle(returnValue);
			}
			catch (System.NullReferenceException ex)
			{
		...
		[MonoPInvokeCallback(typeof(NativeUnityTypeHelpersMethodDowncastUnityEngineGameObjectUnityEngineObjectDelegateType))]
		static int NativeUnityTypeHelpersMethodDowncastUnityEngineGameObjectUnityEngineObject(int objHandle)
		{
			try
			{
				var obj = (UnityEngine.Object)NativeScript.Bindings.ObjectStore.Get(objHandle);
				var returnValue = Native.UnityTypeHelpers.Downcast<UnityEngine.GameObject>(obj);
				return NativeScript.Bindings.ObjectStore.GetHandle(returnValue);
			}
			catch (System.NullReferenceException ex)
			{
...
namespace Native
{
	class BaseNativeScript : Native.AbstractBaseNativeScript
	{
		public int CppHandle;
		
		public BaseNativeScript()
		{
			int handle = NativeScript.Bindings.ObjectStore.Store(this);
			CppHandle = NativeScript.Bindings.NewBaseNativeScript(handle);
		}
		...
		~BaseNativeScript()
		{
			if (CppHandle != 0)
			{
				NativeScript.Bindings.QueueDestroy(NativeScript.Bindings.DestroyFunction.BaseNativeScript, CppHandle);
				CppHandle = 0;
			}
		}
		
		public BaseNativeScript(int cppHandle)
			: base()
		{
			CppHandle = cppHandle;
		}
		...
		public override void Update()
		{
			if (CppHandle != 0)
			{
				...
				NativeScript.Bindings.NativeAbstractBaseNativeScriptUpdate(thisHandle);
		...
		public override void Start()
		{
			...
			{
				int thisHandle = CppHandle;
				NativeScript.Bindings.NativeAbstractBaseNativeScriptStart(thisHandle);
				if (NativeScript.Bindings.UnhandledCppException != null)
				{
					Exception ex = NativeScript.Bindings.UnhandledCppException;
					NativeScript.Bindings.UnhandledCppException = null;
		...
		public override void Awake()
		{
			...
			{
				int thisHandle = CppHandle;
				NativeScript.Bindings.NativeAbstractBaseNativeScriptAwake(thisHandle);
				if (NativeScript.Bindings.UnhandledCppException != null)
				{
					Exception ex = NativeScript.Bindings.UnhandledCppException;
					NativeScript.Bindings.UnhandledCppException = null;
		...
		public override void PassGameConfig(System.IntPtr config)
		{
			if (CppHandle != 0)
			{
				int thisHandle = CppHandle;
				NativeScript.Bindings.NativeAbstractBaseNativeScriptPassGameConfig(thisHandle, config);
				if (NativeScript.Bindings.UnhandledCppException != null)
				{
					Exception ex = NativeScript.Bindings.UnhandledCppException;
					NativeScript.Bindings.UnhandledCppException = null;
		...
		public override void StartSimulation()
		{
			...
			{
				int thisHandle = CppHandle;
				NativeScript.Bindings.NativeAbstractBaseNativeScriptStartSimulation(thisHandle);
				if (NativeScript.Bindings.UnhandledCppException != null)
				{
					Exception ex = NativeScript.Bindings.UnhandledCppException;
					NativeScript.Bindings.UnhandledCppException = null;

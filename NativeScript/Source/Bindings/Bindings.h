...
namespace Native
{
	struct AbstractBaseNativeScript;
}

namespace Native
{
	struct BaseNativeScript;
}

namespace Native
{
	struct BaseNativeEntityView;
}
...
namespace UnityEngine
{
	namespace Profiling
	{
		struct Profiler : virtual System::Object
		{
			Profiler(decltype(nullptr));
			Profiler(Plugin::InternalUse, int32_t handle);
			Profiler(const Profiler& other);
			Profiler(Profiler&& other);
			virtual ~Profiler();
			Profiler& operator=(const Profiler& other);
			Profiler& operator=(decltype(nullptr));
			Profiler& operator=(Profiler&& other);
			bool operator==(const Profiler& other) const;
			bool operator!=(const Profiler& other) const;
			static void BeginSample(System::String& name);
...
namespace Native
{
	struct EventHub : virtual System::Object
	{
		EventHub(decltype(nullptr));
		EventHub(Plugin::InternalUse, int32_t handle);
		EventHub(const EventHub& other);
		EventHub(EventHub&& other);
		virtual ~EventHub();
		EventHub& operator=(const EventHub& other);
		EventHub& operator=(decltype(nullptr));
		EventHub& operator=(EventHub&& other);
		bool operator==(const EventHub& other) const;
		bool operator!=(const EventHub& other) const;
		EventHub();
		void InvokeEntityDestroyed(System::UInt32 e);
	};
}

namespace Native
{
	struct AbstractBaseNativeScript : virtual UnityEngine::MonoBehaviour
	{
		AbstractBaseNativeScript(decltype(nullptr));
		AbstractBaseNativeScript(Plugin::InternalUse, int32_t handle);
		AbstractBaseNativeScript(const AbstractBaseNativeScript& other);
		AbstractBaseNativeScript(AbstractBaseNativeScript&& other);
		virtual ~AbstractBaseNativeScript();
		AbstractBaseNativeScript& operator=(const AbstractBaseNativeScript& other);
		AbstractBaseNativeScript& operator=(decltype(nullptr));
		AbstractBaseNativeScript& operator=(AbstractBaseNativeScript&& other);
		bool operator==(const AbstractBaseNativeScript& other) const;
		bool operator!=(const AbstractBaseNativeScript& other) const;
		Native::EventHub GetEvents();
	};
}

namespace Native
{
	struct BaseNativeScript : virtual Native::AbstractBaseNativeScript
	{
		BaseNativeScript(decltype(nullptr));
		BaseNativeScript(Plugin::InternalUse, int32_t handle);
		BaseNativeScript(const BaseNativeScript& other);
		BaseNativeScript(BaseNativeScript&& other);
		virtual ~BaseNativeScript();
		BaseNativeScript& operator=(const BaseNativeScript& other);
		BaseNativeScript& operator=(decltype(nullptr));
		BaseNativeScript& operator=(BaseNativeScript&& other);
		bool operator==(const BaseNativeScript& other) const;
		bool operator!=(const BaseNativeScript& other) const;
		int32_t CppHandle;
		BaseNativeScript();
		virtual void Update();
		virtual void Start();
		virtual void Awake();
		virtual void PassGameConfig(void* config);
...
namespace Native
{
	struct BaseNativeEntityView : virtual UnityEngine::MonoBehaviour
	{
		BaseNativeEntityView(decltype(nullptr));
		BaseNativeEntityView(Plugin::InternalUse, int32_t handle);
		BaseNativeEntityView(const BaseNativeEntityView& other);
		BaseNativeEntityView(BaseNativeEntityView&& other);
		virtual ~BaseNativeEntityView();
		BaseNativeEntityView& operator=(const BaseNativeEntityView& other);
		BaseNativeEntityView& operator=(decltype(nullptr));
		BaseNativeEntityView& operator=(BaseNativeEntityView&& other);
		bool operator==(const BaseNativeEntityView& other) const;
		bool operator!=(const BaseNativeEntityView& other) const;
		System::UInt32 GetEntityRef();
		void SetEntityRef(System::UInt32 value);
	};
}
...
namespace Native
{
	namespace UnityTypeHelpers
	{
		template<typename MT0> MT0 Downcast(UnityEngine::Object& obj);
	}
}
/*END TYPE DEFINITIONS*/

/*BEGIN MACROS*/
#define NATIVE_NATIVE_SCRIPT_DEFAULT_CONSTRUCTOR_DECLARATION \
	NativeScript(Plugin::InternalUse iu, int32_t handle);
	
#define NATIVE_NATIVE_SCRIPT_DEFAULT_CONSTRUCTOR_DEFINITION \
	NativeScript::NativeScript(Plugin::InternalUse iu, int32_t handle) \
		...
		, Native::BaseNativeScript(iu, handle) \
	{ \
	}
	
#define NATIVE_NATIVE_SCRIPT_DEFAULT_CONSTRUCTOR \
	NativeScript(Plugin::InternalUse iu, int32_t handle) \
		: UnityEngine::Object(nullptr) \
		, UnityEngine::Component(nullptr) \
		, UnityEngine::Behaviour(nullptr) \
...
#define NATIVE_NATIVE_SCRIPT_DEFAULT_CONTENTS_DECLARATION \
	void* operator new(size_t, void* p) noexcept; \
	void operator delete(void*, size_t) noexcept; \
	
#define NATIVE_NATIVE_SCRIPT_DEFAULT_CONTENTS_DEFINITION \
	void* NativeScript::operator new(size_t, void* p) noexcept\
	{ \
		return p; \
	} \
	void NativeScript::operator delete(void*, size_t) noexcept \
	{ \
	}
	
#define NATIVE_NATIVE_SCRIPT_DEFAULT_CONTENTS\
	void* operator new(size_t, void* p) noexcept \
	{ \
		return p; \
	} \
